...
This course gave me a solid introduction to **Git** and **GitHub** — two tools that are essential for anyone working in tech.
...
|--------|-----------------|
| Repository | Your project's home base |
| Branch | A safe copy to work on |
| Commit | A saved checkpoint |
| Pull Request | A request to merge your changes |
| Issue | A task, bug, or feature request |
